class ServiceRepositoryInMemory {
    servicos = [
        {
            id: 1,
            nome: "Limpeza",
            descricao: "Limpeza completa do interior do carro, lavagem do motor, lavagem externa e polimento.",
            preco: 120
        },
        {
            id: 2,
        ...
        },
        {
            ...
            descricao: "Troca de filtros de óleo lubrificante, combustível e de ar. Troca do óleo lubrificante do cárter.",
            preco: 150
        }
    ];
    ...
    async buscarServicoPorId(servicoId) {
        const servico = this.servicos.find(servico => servico.id == servicoId);
